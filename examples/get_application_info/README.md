...
| Name | Description |
|------|-------------|
| <a name="output_unifi_application_version"></a> [unifi\_application\_version](#output\_unifi\_application\_version) | ## Description<br/><br/>  The version of the Unifi application.<br/><br/>  ## Example<br/><br/>  `10.1.68` |
<!-- END_TF_DOCS -->
