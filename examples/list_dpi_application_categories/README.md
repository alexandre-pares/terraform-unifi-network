# Example: List DPI Application Categories

List DPI Application Categories for a specific site.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_dpi_application_categories"></a> [dpi\_application\_categories](#module\_dpi\_application\_categories) | ../../modules/dpi_application_categories | n/a |
...
| Name | Description |
|------|-------------|
| <a name="output_dpi_application_categories"></a> [dpi\_application\_categories](#output\_dpi\_application\_categories) | ## Description<br/><br/>  List of DPI Application Categories managed by the Unifi Network Application.<br/><br/>  ## Learn more<br/><br/>  https://developer.ui.com/network/v10.1.84/getdpiapplicationcategories<br/><br/>  ## Example<pre>hcl<br/>  [<br/>    {<br/>      "id" = 3<br/>      "name" = "File sharing services and tools"<br/>    },<br/>    {<br/>      "id" = 7<br/>      "name" = "Database tools"<br/>    },<br/>    {<br/>      "id" = 9<br/>      "name" = "Management tools and protocols"<br/>    },<br/>    {<br/>      "id" = 14<br/>      "name" = "Security update tools"<br/>    },<br/>    {<br/>      "id" = 17<br/>      "name" = "Business tools"<br/>    },<br/>  ]</pre> |
<!-- END_TF_DOCS -->
