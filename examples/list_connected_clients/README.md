...
List Connected Clients for a specific site.
...
| Name | Description |
|------|-------------|
| <a name="output_clients"></a> [clients](#output\_clients) | ## Description<br/><br/>  List of connected clients managed by the Unifi Network Application.<br/><br/>  ## Learn more<br/><br/>  https://developer.ui.com/network/v10.1.84/getconnectedclientoverviewpage<br/><br/>  ## Example<pre>hcl<br/>  [<br/>    {<br/>      access         = {<br/>        type = "DEFAULT"<br/>      }<br/>      connectedAt    = "2026-02-10T18:46:25Z"<br/>      id             = "b8f25bd9-f045-38b4-9cec-dd887776c3ca"<br/>      ipAddress      = "192.168.1.15"<br/>      macAddress     = "00:e0:4c:00:00:ff"<br/>      name           = "DESKTOP-ABCDEFG 00:FF"<br/>      type           = "WIRED"<br/>      uplinkDeviceId = "86fec8b1-95f8-3ec3-8dc7-9e5cdf6cd5b3"<br/>    },<br/>  ]</pre> |
<!-- END_TF_DOCS -->
