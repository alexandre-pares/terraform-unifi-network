...
| Name | Description |
|------|-------------|
| <a name="output_unifi_local_sites"></a> [unifi\_local\_sites](#output\_unifi\_local\_sites) | ## Description<br/><br/>  List of local sites managed by the Unifi Network Application.<br/><br/>  ## Example<pre>hcl<br/>  [<br/>    {<br/>      "id"                = "4c2d331d-6cdc-39d5-ae48-7457ff007b02"<br/>      "internalReference" = "default"<br/>      "name"              = "Default"<br/>    }<br/>  ]</pre> |
<!-- END_TF_DOCS -->
