# Example: List VPN Servers

List VPN Servers for a specific site.
...
| <a name="module_vpn_servers"></a> [vpn\_servers](#module\_vpn\_servers) | ../../modules/vpn_servers | n/a |
