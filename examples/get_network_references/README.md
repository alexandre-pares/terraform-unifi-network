# Example: Get Network References

Retrieve references about a specific network of a specific site.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_network_references"></a> [network\_references](#module\_network\_references) | ../../modules/network_references | n/a |
