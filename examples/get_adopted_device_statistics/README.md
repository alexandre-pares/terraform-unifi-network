# Example: Get Adopted Device Statistics
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_adopted_device_statistics"></a> [adopted\_device\_statistics](#module\_adopted\_device\_statistics) | ../../modules/adopted_device_statistics | n/a |
