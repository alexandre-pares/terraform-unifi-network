# Example: List WAN Interfaces

List WAN interfaces for a specific site.
...
| <a name="module_wan_interfaces"></a> [wan\_interfaces](#module\_wan\_interfaces) | ../../modules/wan_interfaces | n/a |
